\begin{questions}
    \question{
        The hexagonal numbers satisfy the recursive equation
        $h_n= h_{n-1}+4n-3, h_1=1$.  Explain geometrically
        why this describes these numbers.  A picture of the
        hexagonal numbers is given below.

        \includegraphics{images/hexagonalNumbers.png}
    }
    \begin{solution}
    ...
    \end{solution}
    \question{
        Use induction to show that the closed form
        $h_n=n(2n-1), n\geq 1$ also evaluates to the
        hexagonal numbers.
    }
    \begin{solution}
